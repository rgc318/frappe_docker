...
gateway = {
    ...
    "MYAPP_AI_LANGFUSE_QUEUE_CAPACITY": values["MYAPP_AI_LANGFUSE_QUEUE_CAPACITY"],
    "MYAPP_AI_LANGFUSE_BATCH_SIZE": values["MYAPP_AI_LANGFUSE_BATCH_SIZE"],
    "MYAPP_AI_LANGFUSE_FLUSH_INTERVAL_SECONDS": values["MYAPP_AI_LANGFUSE_FLUSH_INTERVAL_SECONDS"],
    "MYAPP_AI_LANGFUSE_MAX_RETRIES": values["MYAPP_AI_LANGFUSE_MAX_RETRIES"],
    "MYAPP_AI_LANGFUSE_SHUTDOWN_TIMEOUT_SECONDS": values["MYAPP_AI_LANGFUSE_SHUTDOWN_TIMEOUT_SECONDS"],
}
