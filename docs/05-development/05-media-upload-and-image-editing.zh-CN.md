...
| ------------------ | -------- | ------------------------------------------------------------------------------------ | --------------------------------------------- | -------------- |
| `item-flexible-v2` | 商品主图 | 自由、1:1、4:3、3:2、16:9；图片和裁剪框均可移动，四边/四角可缩放，支持横纵切换和旋转 | 保留裁剪比例，最长边 1600px WebP，起始质量 82 | 最短边 300px   |
| `avatar-square-v1` | 用户头像 | 固定 1:1；图片和方形裁剪框均可移动、缩放，支持 90°旋转                               | 固定 512 × 512 WebP，起始质量 85              | 最短边 128px   |
